...
(async () => {
  console.log("\u{1F680} Starting AIForecast Hub (Professional Edition) - Emergency Migration Fix v3.0.0");
  console.log("\u{1F527} CACHE BUST: Force rebuild with migration timing fixes");

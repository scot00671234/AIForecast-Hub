...
function IndexGauge({ value, title, subtitle, classification, onClick }: {
  ...
  return (
    <Card 
      className={`glass-card hover-lift cursor-pointer aspect-square flex flex-col relative overflow-hidden group`}
      onClick={onClick}
    >
        ...
        <div className="space-y-8 md:space-y-16">
          ...
          <section className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
              ...
              {loadingOverall ? (
                <Card className="glass-card aspect-square flex items-center justify-center">

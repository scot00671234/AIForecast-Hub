...
function IndexGauge({ value, title, subtitle, classification, onClick }: {
  ...
  return (
    <Card 
      className={`border-white/10 bg-white/5 backdrop-blur-xl cursor-pointer hover:shadow-2xl transition-all duration-300 hover:scale-105 aspect-square flex flex-col relative overflow-hidden group`}
      onClick={onClick}
    >
      {/* Subtle glare effect */}
